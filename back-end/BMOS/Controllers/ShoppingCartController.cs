    ...
    public class ShoppingCartController : Controller
    {
        ...
        public async Task<IActionResult> Payment(string address, string phone, string note, string pType = "COD", double point = 0)
        {
            ...
            if (userId != null)
            {
                ...
                await EmailSender.SendEmailAsync(username, "Bạn có đơn hàng trên hệ thống ! Vui lòng xác nhận đơn hàng của bạn", "<a href=\"" + content + "\" class=\"linkdetail\" style=\"text-decoration: none; margin: 0 auto; color: black;\">Xác nhận đơn hàng</a>");
            }
